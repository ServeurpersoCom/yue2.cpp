#pragma once
// unicode-table.h: Unicode 15.1.0 data for the frozen tokenizer.
// Generated by tools/gen-unicode.py, sorted for binary search.
//
// DEC:  code point, first part, second part (0 for a singleton)
// COMP: first part, second part, composed code point
// CCC:  range first, range last, canonical combining class
// L, N: ranges of the letter and number categories
//
// Hangul syllables are algorithmic and carry no table entry.

#include <cstdint>

static const uint32_t UNI_DEC[][3] = {
...
static const uint32_t UNI_COMP[][3] = {
...
static const uint32_t UNI_CCC[][3] = {
    { 0x0300,  0x0314,  230 },
    { 0x0315,  0x0315,  232 },
    { 0x0316,  0x0319,  220 },
    { 0x031A,  0x031A,  232 },
...
static const uint32_t UNI_LETTER[][2] = {
    { 0x0041,  0x005A  },
    { 0x0061,  0x007A  },
    { 0x00AA,  0x00AA  },
    { 0x00B5,  0x00B5  },
...
static const uint32_t UNI_NUMBER[][2] = {
    { 0x0030,  0x0039  },
    { 0x00B2,  0x00B3  },
    { 0x00B9,  0x00B9  },
    { 0x00BC,  0x00BE  },
